...
// let result = logMessage("Hello, this is a void function!"); // This will log the message to the console
// console.log(result); // Output: undefined, since the function does not return a value, function finished.
